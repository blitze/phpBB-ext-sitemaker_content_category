...
class admin
{
	 ...
	 */
	public function __construct(\phpbb\request\request_interface $request, \phpbb\language\language $translator, \blitze\category\services\action_handler $action_handler, $return_url = false)
	{
